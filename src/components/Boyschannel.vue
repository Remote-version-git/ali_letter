    ...
    <div class="righteare">
      ...
      <ul class="directory-bottom">
        <li @mouseover="changeNum(item)" v-for="item in array" :key="item.id">
          <a href>{{item.id}}</a>
          <div :class="{'info':item.currentEnce,'infoer':!item.currentEnce}">哈哈哈哈哈哈哈</div>
        </li>
      </ul>
    </div>
      ...
      <div class="newbook-left">
        <div class="newbook-left-top">
          ...
          <div class="side">
            ...
            <p class="author"><a href="">罗霸道</a></p>
            <p>★精华简介★ 高三少年张卓，在人生最倒霉的时刻获得了一幅宇宙</p>
          </div>
        </div>
        <ul class="listrec">
          <li>
            <a href=""><p class="_blank">妙手药王</p></a>
            <p class="auth"><a href="">大肚鱼</a></p>
            <p class="desc">来历不明的神秘少年叶小天突然出现在大都市，创办倾城集团一炮而红，举世震惊，
              他那出神入化的医术不仅引得无数重症患者慕名前来求医，还能让各种奇花异草、珍贵药材疯狂生长，百年山参？
              一月养成，千年灵芝？给我三个月时间，救美女，医富豪，赚大钱，拳打地痞，针剌流氓，在红颜知己的帮助下，
              一路高歌，上演了属于他叶医生的时代。</p>
          </li>
          <li>
            <a href=""><p class="_blank">九卷风云录</p></a>
            <p class="auth"><a href="">辛辛木</a></p>
            <p class="desc">云洲的皇帝死去的那一年，天下就乱了，四海虎视眈眈，三邦蠢蠢欲动，
              这时候从西海来了一个传奇，拯救了即将分崩离析的云洲，在人们都以为这个传奇将成为新的云洲之主时，
              这个人消失了。十几年过去了，许多事情被遗忘，包括那个死去的皇帝，
              包括那个传奇，就像沽噜河的河水滚滚而去，故事就从这个沽噜河岸边的一个少年讲起。</p>
          </li>
        </ul>
      </div>
    ...
    <div class="booklist">
      <div>
          ...
          <div>
            ...
            <p class="desc">视之无形，听之无声，谓之幽冥。幽冥者，所以喻道而非道也</p>
          </div>
...
<div class="update">
 <div class="lefteare">
      <div class="titlelines">
        ...
        <a href=""><span class="but">查看全部</span></a>
      </div>
      <ul class="list">
          <li class="th">
            <span>类型</span>
...
export default {
  data() {
    return {
      array: [
        { id: 1, currentEnce: true },
        { id: 2, currentEnce: false },
        { id: 3, currentEnce: false },
        { id: 4, currentEnce: false },
        { id: 5, currentEnce: false },
        { id: 6, currentEnce: false }
      ]
    };
  },
  methods: {
