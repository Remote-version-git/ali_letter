    ...
    <el-tabs type="border-card" v-model="activeName">
      <el-tab-pane label="连载中" name="serialize">
        ...
        <el-table :data="serializeDate" border style="width: 100%">
          ...
          <el-table-column prop="novel_title" label="标题" width="180"></el-table-column>
          <el-table-column prop="novel_desc" label="简介" width="180"></el-table-column>
